"""
Modificado do arquivo original LIT
Criado em 07 de fevereiro de 2021
...
# Pedro: adicionando este modulo
from lit_nlp.examples.datasets import userdataset
...
def main(_):
  ...
  datasets = {
      ...
      # Pedro: adicionando novo dataset: User data. Demo data.
      "User_dataset": userdataset.DemoData(),
  }
